...
class RVDummyDataListFragment : Fragment(), RVDummyDataListInterface,
    RVDummyDataListClickInterface {

    private val TAG = "RVListFragment"
    lateinit var viewModel: MainViewModel
    lateinit var binding: FragmentRvDummyDataListBinding
    lateinit var recylerViewListAdapter: RVDummyDataListAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        recylerViewListAdapter = RVDummyDataListAdapter(this)
